...
2. **Opening Project File**: If you have Power BI Desktop, you can download the .pbix file from the [Dashboard Folder](Dashboard/Global_CCS_Map_Dashboard.pbix) with the full/unfiltered dashboard.
